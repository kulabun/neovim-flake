...
vim.opt.completeopt = { 'menu', 'menuone', 'noinsert' } -- Options for insert mode completion
...
vim.opt.history = 500 -- Number of commands to remember in a history table
...
-- Disable comment propagation to new line
